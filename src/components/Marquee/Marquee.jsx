    ...
    <div className="marquee">
      <div className="marquee-wrapper" ref={wrapperRef}>
        <div className="marquee-content">
          <h1>
          Valuable Insights, Intelligent Investments — Valuable Insights, Intelligent Investments — Valuable Insights, Intelligent Investments —
          Valuable Insights, Intelligent Investments —
          </h1>
        </div>
      </div>
    </div>
